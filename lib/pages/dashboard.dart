...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DashboardCubit, int>(builder: (_, state) {
      return WillPopScope(
        onWillPop: () {
  ...
  void _changeContent(BuildContext context, int index) {
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        BlocProvider.of<DashboardCubit>(context).getServers();
        break;
      case 2:
        BlocProvider.of<DashboardCubit>(context).getBookmarks();
        break;
      case 3:
        BlocProvider.of<DashboardCubit>(context).getSettings();
        break;
    }
  }
